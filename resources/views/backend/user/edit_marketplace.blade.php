...
@section('admin')
    <div class="container-fluid">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="user" method="POST" action="{{ route('marketplace.update', $data->id) }}"
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-lg @error('judul') is-invalid @enderror"
                                id="name" placeholder="Nama Barang" value="{{$data->judul}}" name="judul">
                            @error('judul')
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control form-control-lg @error('harga') is-invalid @enderror"
                                id="harga" placeholder="Harga" value="{{$data->harga}}" name="harga">
                            @error('harga')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control form-control-lg @error('no_wa') is-invalid @enderror"
                                id="link" value="{{$data->no_wa}}" placeholder="No WA{ubah 0 menjadi 62. etc=6287821234658}" name="no_wa">
                            @error('no_wa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
