                ...
                <form class="user" method="POST" action="{{route('cash.add')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control" placeholder="keterangan_cash"
                                name="keterangan_cash" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="nominal">Nominal</label>
                            <input type="number" class="form-control form-control" id="nominal"
                                placeholder="Nominal" name="nominal" required>
                        </div>
                    </div>
